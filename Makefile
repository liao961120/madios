...
# Template: app
# Command: /usr/lib/qt5/bin/qmake -o Makefile ModifiedADIOS.pro -unix
#############################################################################
...
CXXFLAGS      = -pipe -O2 -pedantic -ansi -Wall -W -fPIC $(DEFINES)
...
DISTDIR = /home/yf/Desktop/madios-master/.tmp/ModifiedADIOS1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1
LIBS          = $(SUBLIBS)    
AR            = ar cqs
...
Makefile: ModifiedADIOS.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		...
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/lex.prf \
		ModifiedADIOS.pro
	$(QMAKE) -o Makefile ModifiedADIOS.pro -unix
